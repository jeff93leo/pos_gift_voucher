openerp.pos_gift_voucher = function(instance) {//create our own module instance

    instance.pos_gift_voucher = {};
    var module = instance.point_of_sale; //create the instance of point_of_sale module

    openerp_pos_gift_voucher_models(instance, module);
    openerp_pos_gift_voucher_screens(instance, module);
    openerp_pos_gift_voucher_devices(instance, module);
    openerp_pos_gift_voucher_widgets(instance,module);    // import widgets.js by calling function in widgets.js i.e. paymentscreen_widgets
};
...
(function ($) {
	...
	/*
	function OnLoadDiv(div_id,sr_no){
		alert ("in onload function")
		divElement = document.getElementById(div_id);
		//alert("divElement"+divElement)
		var timeText = sr_no;
		divElement.id = sr_no
	   divElement.innerHTML = barcode(timeText,"code39",{barWidth:2, barHeight:80});
	//$("#bar1").barcode("1234567890128", "ean13",{barWidth:2, barHeight:30});
	}*/
